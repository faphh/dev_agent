...
const DEFAULT_PREFIX = `You are Dev Agent, an AI coding assistant.`
const AGENT_SDK_CLAUDE_CODE_PRESET_PREFIX = `You are Dev Agent, an AI coding assistant, running within the Agent SDK.`
