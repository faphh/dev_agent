...
export const DESCRIPTION = 'Get or set Dev Agent configuration settings.'
...
export function generatePrompt(): string {
  ...
  return `Get or set Dev Agent configuration settings.

  View or change Dev Agent settings. Use when the user requests configuration changes, asks about current settings, or when adjusting a setting would benefit them.
