...
// Always ask when Dev Agent tries to edit its own config files
 ...
 * This is a per-user temporary directory used by Dev Agent for all temp files.
 *
 ...
 * - MCP CLI state files (managed internally by Dev Agent)
