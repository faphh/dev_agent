...
export function getUserAgent(): string {
  ...
  return `dev-agent/${MACRO.VERSION} (${process.env.USER_TYPE}, ${process.env.CLAUDE_CODE_ENTRYPOINT ?? 'cli'}${agentSdkVersion}${clientApp}${workloadSuffix})`
}
...
export function getMCPUserAgent(): string {
  ...
  return `dev-agent/${MACRO.VERSION}${suffix}`
}
