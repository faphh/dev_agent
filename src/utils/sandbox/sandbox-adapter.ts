...
} from '../../stubs/@anthropic-ai/sandbox-runtime/index.js'
import {
...
/**
 * Resolve Dev Agent-specific path patterns for sandbox-runtime.
 *
 * Dev Agent uses special path prefixes in permission rules:
...
/**
 * Convert Dev Agent settings format to SandboxRuntimeConfig format
...
export function convertToSandboxRuntimeConfig(
  ...
  // This blocks settings in the original working directory (where Dev Agent started)
