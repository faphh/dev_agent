...
export const MACOS_BUNDLE_ID = 'com.devagent.dev-agent-url-handler'
const APP_NAME = 'Dev Agent URL Handler'
const DESKTOP_FILE_NAME = 'dev-agent-url-handler.desktop'
const MACOS_APP_NAME = 'Dev Agent URL Handler.app'
...
<dict>
  ...
  <array>
    <dict>
      ...
      <string>Dev Agent Deep Link</string>
...
Name=${APP_NAME}
Comment=Handle ${DEEP_LINK_PROTOCOL}:// deep links for Dev Agent
