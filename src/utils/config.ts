...
export type GlobalConfig = {
  ...
  firstStartTime?: string // ISO timestamp when Dev Agent was first started on this machine
  ...
  // Dev Agent usage tracking
  claudeCodeFirstTokenDate?: string // ISO timestamp of the user's first Dev Agent OAuth token
  ...
  // Dev Agent hint protocol state (<claude-code-hint /> tags from CLIs/SDKs).
